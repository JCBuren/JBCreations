...
const ProjectItem = ({title, backgroundImg, tech, projectUrl}) => {
    return (
        <div className='relative flex justify-center max-h-[300px] max-w-[600px] shadow-xl shadow-gray-400 rounded-xl group hover:bg-gradient-to-r from-[#ef8d37] to-[#b58c34]'>
